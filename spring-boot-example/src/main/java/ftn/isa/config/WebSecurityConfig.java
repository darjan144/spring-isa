...
import ftn.isa.auth.RestAuthenticationEntryPoint;
import ftn.isa.auth.TokenAuthenticationFilter;
...
public class WebSecurityConfig
{
	...
	public DaoAuthenticationProvider authenticationProvider() 
	{
	    ...
	    // da bi adekvatan hash koji dobije kao rezultat hash algoritma 
 	    //uporedio sa onim koji se nalazi u bazi (posto se u bazi ne cuva plain lozinka)
